...
unique_lakes <- joined_dfs |> 
  select(Site, Latitude, Longitude, Elevation, AvgDepth, AvgTemp) |>  # removed Date column (among others) here, which is essential for our distinct() step
  distinct()


# save processed data to app's data directory ----
# from {readr}'s write_*() (write_delim)
